...
package com.getsoftwareCO.bajarvideosamicelulargratis.download.frag;
...
import com.getsoftwareCO.bajarvideosamicelulargratis.activity.Settings;
import com.getsoftwareCO.bajarvideosamicelulargratis.browser.BrowserManager;
import com.getsoftwareCO.bajarvideosamicelulargratis.download.list.DownloadQueues;
import com.google.android.material.bottomnavigation.BottomNavigationView;
import com.google.android.material.floatingactionbutton.FloatingActionButton;
import com.getsoftwareCO.bajarvideosamicelulargratis.download.OnDownloadWithNewLinkListener;
...
import com.getsoftwareCO.bajarvideosamicelulargratis.download.DownloadPermissionHandler;
import com.getsoftwareCO.bajarvideosamicelulargratis.download.DownloadVideo;
import com.getsoftwareCO.bajarvideosamicelulargratis.download.Tracking;
import com.getsoftwareCO.bajarvideosamicelulargratis.utils.RenameDialog;
import com.getsoftwareCO.bajarvideosamicelulargratis.utils.Utils;
...
public class DownloadsInProgress extends VDFragment implements DownloadManager.OnDownloadFinishedListener, DownloadManager.OnLinkNotFoundListener, OnDownloadWithNewLinkListener {
    ...
    private ImageView btnHome, btnSet;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (view == null) {
            ...
            btnSet = view.findViewById(R.id.btn_settings);
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            ...
                            if (i == R.id.download_progress_delete) {
                                new AlertDialog.Builder(activity)
                                        .setMessage("Deseas eliminar estos elementos?")
